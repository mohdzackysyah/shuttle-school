        ...
        <div class="card border-0 shadow-sm rounded-4 mb-3 overflow-hidden">
            ...
            <div class="card-header bg-white p-0 border-0">
                <div class="d-flex align-items-center">
                    ...
                    <button class="accordion-button collapsed shadow-none bg-white p-4 flex-grow-1" type="button" data-bs-toggle="collapse" data-bs-target="#collapse{{ $routeId }}" aria-expanded="false">
                        <div class="d-flex align-items-center gap-3 w-100 me-3">
                            ...
                            <div class="text-start">
                                {{-- PENGAMAN: Tambahkan ?? '...' jika data hilang --}}
                                ...
                                <div class="d-flex align-items-center text-muted small gap-2 flex-wrap">
                                    <span>
                                        ...
                                        {{ $firstItem->driver->name ?? 'Tanpa Driver' }}
                                    </span>
                                    <span class="d-none d-sm-inline text-light-gray">|</span>
                                    <span>
                                        <i class="bi bi-bus-front me-1 text-secondary"></i> 
                                        {{ $firstItem->shuttle->plate_number ?? 'Tanpa Mobil' }}
                                    </span>
                                    <span class="d-none d-sm-inline text-light-gray">|</span>
                    ...
                    {{-- 2. TOMBOL EDIT RANGKAIAN (Di luar tombol collapse agar bisa diklik terpisah) --}}
                    <div class="pe-4 d-none d-md-block">
                        <a href="{{ route('schedules.editBulk', $firstItem->id) }}" class="btn btn-sm btn-warning fw-bold shadow-sm text-nowrap">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-start">
                                            ...
                                            <small class="text-muted lh-sm">
                                                {{-- Tampilkan nama 5 siswa pertama --}}
